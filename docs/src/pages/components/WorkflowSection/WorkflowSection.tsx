...
const WorkflowStep = ({ icon, title, description, isReversed = false }) => {
  const content = (
    <>
      ...
      <div className="container">
        ...
        <div className={styles.stepsContainer}>
          <WorkflowStep
            ...
            description={
              <>
                Run <code>codeai analyze .</code> in your terminal for a
                seamless Git-integrated workflow.{' '}
                <strong>
                  Or, simply upload a .zip file directly in our web app.
                </strong>
              </>
            }
          />
